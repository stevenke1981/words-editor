      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm status-panel overflow-hidden">
        ...
        <div className="p-4 space-y-4 text-sm">
              ...
              <div>
                ...
                <div className="h-2 bg-slate-100 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{ width: `${currentChapter.retention}%` }}
                  />
                </div>
              </div>
              <div>
                ...
                <div className="h-2 bg-slate-100 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{ width: `${currentChapter.rewrite}%` }}
                  />
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-1 text-xs">
              ...
              {(currentChapter.references || []).map((ref) => (
                <div
                  key={`${ref.date}:${ref.title}`}
                  className="flex items-center gap-x-2 text-slate-600 bg-slate-50 px-2 py-1 rounded-lg"
                >
          ...
          <div>
            ...
            <textarea
              id="chapter-inspiration-notes"
              name="chapter-inspiration-notes"
              value={currentChapter.inspirationNotes || ''}
              onChange={(e) =>
                onUpdateChapter(currentChapterId, { inspirationNotes: e.target.value })
              }
